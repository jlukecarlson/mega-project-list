...
**Reverse a String** ([Python](https://github.com/jLukeC/mega-project-list/blob/master/python/reverse_string.py) | [Java](https://github.com/jLukeC/mega-project-list/blob/master/java/src/projects/ReverseString.java))– Enter a string and the program will reverse it and print it out.

**Pig Latin**([Python](https://github.com/jLukeC/mega-project-list/blob/master/python/pig_latin.py)) – Pig Latin is a game of alterations played on the English language game. To create the Pig Latin form of an English word the initial consonant sound is transposed to the end of the word and an ay is affixed (Ex.: "banana" would yield anana-bay). Read Wikipedia for more information on rules.

**Count Vowels**([Python](https://github.com/jLukeC/mega-project-list/blob/master/python/count_vowels.py)) – Enter a string and the program counts the number of vowels in the text. For added complexity have it report a sum of each vowel found.

**Check if Palindrome**([Python](https://github.com/jLukeC/mega-project-list/blob/master/python/palindrome.py)) – Checks if the string entered by the user is a palindrome. That is that it reads the same forwards as backwards like “racecar”

**Count Words in a String**([Python](https://github.com/jLukeC/mega-project-list/blob/master/python/count_words.py)) – Counts the number of individual words in a string. For added complexity read these strings in from a text file and generate a summary.

**Text Editor**([Python-Advanced](https://github.com/jLukeC/advanced-text-editor) | [Python-Simple](https://github.com/jLukeC/mega-project-list/blob/master/python/text-editor/basic_text_editor.py)) – Notepad style application that can open, edit, and save text documents. Add syntax highlighting and other features.
